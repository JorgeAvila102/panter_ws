...
KeyboardcontrolTorque::KeyboardcontrolTorque(): Node ("keyboardcontrolTorque")
{
    ...
    ackermann_publisher = this->create_publisher<geometry_msgs::msg::TwistStamped>(
...
// Set console raw mode. To avoid pressing enter after each character
    ...
    // AVANZA HACIA ADELANTE
        ...
        case 'w':   RCLCPP_INFO(this->get_logger(), "FORDWARDS \r\n");
            ...
            command.twist.linear.x = vel_l; // Velocidad en m/s
            command.twist.angular.z = 0; // Velocidad en rad/s
    ...
    // GIRA DERECHA AVANZANDO
        ...
        RCLCPP_INFO(this->get_logger(), "RIGHT \r\n");
            ...
            command.twist.linear.x = vel_l; // Velocidad en m/s
            command.twist.angular.z = -vel_w; // Velocidad en rad/s
    ...
    // PARAR
        ...
        RCLCPP_INFO(this->get_logger(), "STOP \r\n");
            ...
            command.twist.linear.x = 0; // Velocidad en m/s
            command.twist.angular.z = 0; // Velocidad en rad/s
    ...
    // SALIR DE MODO RAW
        ...
        command.twist.angular.y = 0.0;
        // command.twist = tw;
        ackermann_publisher -> publish(command);
